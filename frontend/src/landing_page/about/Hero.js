...
function Hero() {
    return (
        <div className="container">
            ...
            <div className="row p-5 m-3 border-top text-muted fs-6" style={{ lineHeight: "1.8", fontSize: "1.2rem" }}>
                ...
                <div className="col-6 p-5">
                    ...
                    <p><a href="https://rainmatter.com/" target="_blank" className="text-decoration-none">
                        Rainmatter
                    </a>,our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p>
